...
import { MemoryRouter } from '@testing-library/user-event';
import userEvent from '@testing-library/user-event';
import axios from 'axios'; // This is fake version of axios
...
describe('HomePage component',() => {
    ...
    beforeEach(() => {
        loadCart = vi.fn(); //creating fake loadCart function;

        axios.get.mockImplementation(async (urlPath) => { 
            if (urlPath === '/api/products') { //replace real axios.get with fake data by using mock
                return {
                    data:[{
  ...
  },
  {
    ...
    "keywords": ["sports", "basketballs"]
        ...
        user = userEvent.setup(); // create user object for clicking or typing
    });
   ...
   it('add a product to the cart', async () => {
    ...
    expect(axios.post).toHaveBeenNthCalledWith(1, '/api/cart-item', {
      productId: 'e43638ce-6aa0-4b85-b27f-e1d07eb678c6',
      quantity:2
    });

  expect (axios.post).toHaveBeenNthCalledWith(2, '/api/cart-item', {
